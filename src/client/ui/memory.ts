...
import { MemoryData, SwapData } from '../../shared/types.js';

export function renderMemory(mem?: MemoryData | null): void {
  if (!mem) {
...
export function renderSwap(swap?: SwapData | null): void {
  if (!swap) {
